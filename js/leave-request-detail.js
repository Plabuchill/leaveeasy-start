...
(async function () {
  ...
  try {
    ...
    // firestore.rules ปฏิเสธหรือโหลดไม่สำเร็จ — permission-denied เกิดได้ทั้งตอน
    // employee เปิดใบของคนอื่นตรงๆ ผ่าน URL และตอนใบถูกลบไปแล้ว (rules แยกสองเคสนี้ไม่ได้
    // เพราะเอกสารที่ไม่มีอยู่จริงทำให้เช็คเจ้าของใบไม่ได้ ข้อความเลยครอบคลุมทั้งสองกรณี)
    if (err.code === "permission-denied") {
      alert("ไม่พบใบขอลาที่ต้องการ หรือคุณไม่มีสิทธิ์ดูใบลาของคนอื่น");
    } else {
